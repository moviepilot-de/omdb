class DependencyViews < ActiveRecord::Migration
  def self.up
    add_index :casts, [ :movie_id, :person_id ], :name => 'movie_and_person_index'
    add_index :casts, [ :movie_id, :character_id ], :name => 'movie_and_character_index'
    add_index :movie_countries, [ :movie_id, :country_id ], :name => 'movie_and_country_index'
    remove_index :movie_countries, :name => 'movie_id'
  ...
  def self.down
    remove_index :casts, :name => 'movie_and_person_index'
    remove_index :casts, :name => 'movie_and_character_index'
    remove_index :movie_countries, :name => 'movie_and_country_index'
